...
const BLOG = {
  ...
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.theyixiang.top', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客, YiXiang, Ethan Xu, Xuye', // 网站关键词 英文逗号隔开
  ...
  GREETING_WORDS:
    ...
    'Hi，我是一个打工, Hi，我是一个普通,Hi，我是一个干饭人,欢迎来到我的博客🎉',
